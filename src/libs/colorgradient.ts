class Gradient {
    ...
    constructor(gradients: GradientColor[] = [], maxNum = 10, colors = ['', ''], intervals: any = []) {

        const setColors = (props: string[]) => {
            if (props.length < 2) {
...
class GradientColor {
    ...
    constructor(startColor = '', endColor = '', minNum = 0, maxNum = 10) {
        ...
        const getHexColor = (props: string) => {
